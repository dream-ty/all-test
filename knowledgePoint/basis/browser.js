// “从URL输入到渲染”会主要涉及到的，是浏览器进程、网络进程和渲染进程这三个：
...
// 协商加密密钥——TLS握手
// 了保障通信的安全，我们使用的是HTTPS协议，其中的S指的就是TLS。TLS使用的是一种非对称+对称的方式进行加密。
...
// script没有放在最后并操作了cssom 可能阻塞html解析
...
{/* <link href="https://cdn.domain.com" rel="preconnect" crossorigin></link> */}
